...
<div class="infrastructure-form">
    ...
    <div class="col-md-6">
        <?= $form->field($model, 'title')->textInput(['maxlength' => true])->label('Название инфраструктуры:') ?>
        ...
        <?= $form->field($model, 'l_text')->textInput(['maxlength' => true])->label('Текст слева от фото:') ?>

        <?= $form->field($model, 'r_text')->textInput(['maxlength' => true])->label('Текст справа от фото:') ?>
